About opentelemetry-instrumentation-openai-agents-feedstock
===========================================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/opentelemetry-instrumentation-openai-agents-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/opentelemetry-instrumentation-openai-agents-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add opentelemetry-instrumentation-openai-agents
# for installing globally
pixi global install opentelemetry-instrumentation-openai-agents
```
...
It is possible to list all of the versions of `opentelemetry-instrumentation-openai-agents` available on your platform:
...
```
pixi search opentelemetry-instrumentation-openai-agents --channel conda-forge
```
